...
# Load GTF file
gtf <- read_tsv('~/Candidates/Arabidopsis_arenosa_genome.annotation.simple.gtf', col_names = FALSE)
...
# Find the nearest genes to all high Fst regions within 5 Kb
...
write_tsv(all_gene_hits, '~/Candidates/NT_candidate.tsv')